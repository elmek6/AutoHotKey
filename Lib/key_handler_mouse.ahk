        ...
        try {
            ...
            while GetKeyState(key, "P") {
                ...
                if (_checkCombo(b.combos)) {
                    if (gestures.Length > 0 && IsObject(this.cgs)) {
                        this.cgs.Stop()
                    }
                    break
                }
            ...
            ; ColdGestures sonuç kontrolü
            if (gestures.Length > 0) {
                this.cgs.Stop() ; ColdGestures zaten callback'leri çağırdı
            }
