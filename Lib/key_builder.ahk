...
; KULLANILMIYOR + BOZUK: lastX/lastY hiçbir yerde başlatılmadığından çağrılırsa
; "variable has not been assigned" hatası verir. Yeniden yapılandırılana kadar yorumda.
; UpdateIndicator() {
